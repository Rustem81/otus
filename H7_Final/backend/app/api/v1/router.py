...
from app.api.v1.endpoints import admin, advertisements, auth, auth_oauth, blacklist, history, profile, scoring
...
# OAuth2 endpoints
api_v1_router.include_router(auth_oauth.router, prefix="/auth", tags=["auth-oauth"])
